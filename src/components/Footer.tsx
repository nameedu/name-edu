...
const Footer = () => {
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex space-x-4 mb-4">
                <a href="#" className="bg-neutral-700 p-2 rounded-full hover:bg-primary transition-colors">
      ...
      {/* Fixed Action Links */}
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg py-3 px-4 flex justify-center space-x-4 md:space-x-8">
        <Link
          to="/online-form"
